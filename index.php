...
<style>
    ...
    <style>
    body {
        background-image: url('https://i.pinimg.com/1200x/ea/50/a2/ea50a27e7a08e2e224e16204a6d16d8e.jpg');
        background-size: cover;          /* Image covers whole screen */
        background-repeat: no-repeat;    /* Prevents repeating */
        background-position: center;     /* Center the image */
        background-attachment: fixed;    /* Parallax-like fixed background */
    }

    /* Add a soft overlay so text stays readable */
    body::before {
        content: "";
        position: fixed;
        top: 0;
    ...
    padding: 150px 0; /* adjust banner height */
}
.banner_text_iner h5 {
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="https://i.pinimg.com/736x/89/b4/14/89b4147c8916caa75ca82d3fdf4eed81.jpg" alt="#">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="https://i.pinimg.com/736x/9a/a1/a0/9aa1a018b0c3639ddcca5ad2a3b19dae.jpg" alt="#">
                        <div class="hover_text">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="https://i.pinimg.com/736x/d8/e1/3c/d8e13c0e8daa95d6025fbe9f4c8207fb.jpg" alt="#">
                        <div class="hover_text">
